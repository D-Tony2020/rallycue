        ...
        <div className="max-w-3xl">
          ...
          >
            {[
              ...
              { value: "$50/mo", label: "Pro Coaching Plan" },
            ].map((stat) => (
              <div key={stat.label}>
                <div
...
function ProblemSection() {
  ...
  return (
    <section id="problem" ref={ref} className="relative py-24 lg:py-32 bg-[#0A0A0A] overflow-hidden">
      {/* Background texture */}
...
function ProductSection() {
  ...
  return (
    <section id="product" ref={ref} className="relative py-24 lg:py-32 overflow-hidden" style={{ background: "#0D0D0D" }}>
      {/* Subtle orange glow */}
...
function TechPipelineSection() {
  ...
  return (
    <section id="tech" ref={ref} className="relative py-24 lg:py-32 overflow-hidden" style={{ background: "#0A0A0A" }}>
      {/* Background texture */}
...
function StoryboardSection() {
  ...
  return (
    <section id="storyboard" ref={ref} className="relative py-24 lg:py-32 overflow-hidden" style={{ background: "#0D0D0D" }}>
      {/* Lime glow */}
...
function CompetitorSection() {
  ...
  return (
    <section id="competitors" ref={ref} className="relative py-24 lg:py-32 overflow-hidden" style={{ background: "#0D0D0D" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="grid lg:grid-cols-5 gap-8 items-stretch">
          {/* Matrix */}
          <div
            className="lg:col-span-3 relative rounded-sm p-6"
            style={{
              background: "rgba(255,255,255,0.02)",
              border: "1px solid rgba(255,255,255,0.06)",
              aspectRatio: "1 / 1",
...
const funnel = [
  { label: "TAM", value: "$55B", tag: "All U.S. sport players", width: "100%", color: "rgba(255,255,255,0.5)" },
  { label: "SAM", value: "$16B", tag: "Net-sport enthusiasts", width: "72%", color: "#C8FF00" },
  { label: "SOM", value: "$600M", tag: "Our obtainable market", width: "44%", color: "#E84B1A" },
];

const sports = [
  { name: "Tennis",     total: 25.7, corePct: 50, demoPct: 22, convPct: 18, payers: 509, revenue: 305 },
  { name: "Pickleball", total: 19.8, corePct: 31, demoPct: 22, convPct: 15, payers: 203, revenue: 122 },
  { name: "Baseball",   total: 16.7, corePct: 40, demoPct: 20, convPct: 13, payers: 174, revenue: 104 },
  { name: "Badminton",  total:  6.4, corePct: 30, demoPct: 40, convPct: 15, payers: 115, revenue:  69 },
];
...
function MarketScaleSection() {
  ...
  return (
    <section id="market" ref={ref} className="relative py-24 lg:py-32 overflow-hidden" style={{ background: "#0A0A0A" }}>
      <div className="absolute inset-0 opacity-[0.04] pointer-events-none"
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        >
          <div className="p-5 border-b border-white/5 flex flex-wrap items-baseline justify-between gap-3">
            <div>
              <div className="nf-section-label mb-1">How We Get to $600M</div>
              <div className="text-white/80 text-sm" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                Total × Core% × Demo% × Conv% × $600 AOV → Payers × AOV → Revenue
              </div>
            </div>
...
function PricingSection() {
  ...
  return (
    <section id="pricing" ref={ref} className="relative py-24 lg:py-32 bg-[#0A0A0A] overflow-hidden">
      {/* Background glow */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        >
          ...
          <div className="rounded-sm p-5" style={{ background: "rgba(232,75,26,0.08)", border: "1px solid rgba(232,75,26,0.3)" }}>
            ...
            <div className="flex items-baseline gap-2">
              <span className="nf-display" style={{ fontSize: "2rem", color: "#E84B1A" }}>$600</span>
              <span className="text-white/40 text-xs">/ year · 5× cheaper</span>
            </div>
...
function SignupSection() {
  ...
  if (submitted) {
    return (
      <section id="signup" ref={ref} className="relative py-24 lg:py-32 bg-[#0A0A0A]">
  ...
  return (
    <section id="signup" ref={ref} className="relative py-24 lg:py-32 overflow-hidden">
      {/* Background */}
      <div
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              ...
              <div>
                <label className="block text-white/60 text-xs uppercase tracking-widest mb-3" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                  Would you pay $50/month for always-on AI coaching (hardware ~$50)? *
                </label>
